...
const formSteps: FormField[][] = [
    ...
    [
        ...
        { id: 'email', label: 'Email Address', type: 'email', color: '#F4B400', delay: '0.5s', required: true },
        { id: 'phoneNumber', label: 'Phone Number', type: 'tel', color: '#DB4437', delay: '0.8s', required: true },
