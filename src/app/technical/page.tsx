...
const Page: FC = () => {
    ...
    const renderContent = () => {
        switch (submissionStatus) {
            ...
            default:
                return (
                    <div className="hologram-card w-full max-w-lg backdrop-blur-md overflow-hidden">
    ...
    return (
        <>
            ...
            <main className="min-h-screen font-['Roboto_Mono',_monospace] bg-black text-white">
